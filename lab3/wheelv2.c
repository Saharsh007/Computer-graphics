...
void concentric_circles(vogluOrtho2Did)
{
    ...
    // //1
    // x1 = r1*cos(theta) + xc, y11 = r1*sin(theta) + yc, x2 = r2*cos(theta)  + xc, y2 = r2 + yc;
    // drawlines();
    // //2
    // x1 = r1*cos(theta+pi/4)+ xc, y11 = r1/sqrt(2) + yc, x2 = r2*cos(theta+pi/4) + xc , y2 = r2/sqrt(2) + yc;
    // drawlines();
    // //3
    // x1 = r1*cos(theta+pi/2) + xc, y11 = 0 + yc, x2 = r2 + xc , y2 = 0 + yc;
    // drawlines();
    // //4
    // x1 = r1*cos(theta+3*pi/4) + xc, y11 = -r1/sqrt(2) + yc, x2 =  r2/sqrt(2)  + xc, y2 =  -r2/sqrt(2) + yc;
    // drawlines();
    // //5
    // x1 = r1*cos(theta+pi) + xc, y11 = -r1 + yc, x2 = 0 + xc , y2 = -r2 + yc;
    // drawlines();
    // //6
